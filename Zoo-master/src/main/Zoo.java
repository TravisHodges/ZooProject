...
public class Zoo
{
    public static  void main(String[] args) throws InterruptedException 
    {
        ...
        System.out.println(Math.random() < .8 ? "\nHave a nice day!  Hope you come back!" : " An escaped lion eats you on your way out.  Sorry!");
    ...
    public static void populateAnimals(List<Animal> animals)
    {
        ...
        types.Primate hairy = new types.Primate();
        animals.add(hairy);
        animals.Chimpanzee george = new animals.Chimpanzee();
        add(george);
